  ...
  const ComplaintCard = ({ complaint }) => {
    ...
    return (
      <Box
        ...
        borderLeftColor={`${getPriorityColor(complaint.priority)}.500`}
      >
        <Box p={6}>
          <VStack align="stretch" spacing={4}>
            ...
            <HStack justify="space-between" width="100%">
              <HStack>
                <Button size="sm" variant="outline" display="flex" alignItems="center">
                  <FaEye size={14} style={{ marginRight: '6px' }} /> View
                </Button>
                <Button size="sm" colorScheme="blue" display="flex" alignItems="center">
                  <FaReply size={14} style={{ marginRight: '6px' }} /> Respond
                </Button>
              </HStack>
      ...
      <VStack align="stretch" spacing={6}>
        ...
        <Flex justify="space-between" align="center">
          ...
          <Button
            ...
            alignItems="center"
          >
            <FaPlus style={{ marginRight: '8px' }} /> New Complaint
          </Button>
        </Flex>
